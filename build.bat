...
if %errorlevel%==0 (
    ...
    cl /nologo /O2 /W3 sound_recorder.c audio_capture.c wav.c encoder.c audio_util.c mp3_encoder.c resources.res /link /SUBSYSTEM:WINDOWS ole32.lib user32.lib gdi32.lib shell32.lib mfplat.lib mf.lib mfreadwrite.lib mfuuid.lib /OUT:WindowsSoundRecorder.exe
